...
# lưu dữ liệu 
def save_data_for_booking_tour_basic_in_table( fullname, email, timeCheckin, days, booking_tour_name, price, number_adults, number_children, hotel_infor, createdTime):
    ...
    cursor.execute(f"INSERT INTO booking_tour_basic1 (fullname, email, timeCheckin, days, booking_tour_name, price, number_adults, number_children, hotel_infor, createdTime) VALUES (?,?,?,?,?,?,?,?,?,?)",
               (fullname, email, timeCheckin, days, booking_tour_name, price, number_adults, number_children, hotel_infor, createdTime))
