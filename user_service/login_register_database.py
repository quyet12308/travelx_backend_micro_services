...
# update base password to hash password
# pass_word1 = "123456a"
# list_emails = [
#     "1@gmail.com",
#     "quyet12308@gmail.com",
#     "cuong.fithau@gmail.com",
#     "quyet12306@gmail.com",
#     "tngthanh62@gmail.com",
#     "nguyenviet212002@gmail.com",
# ]
# for email in list_emails:
#     # data = query_database_for_login_register_by_email(email=email)
#     # pass_word = data["password"]
#     # print(pass_word)
#     hashpassword = hash_password(password=pass_word1)
#     update_user_by_email(email=email, column="password", value=hashpassword)
#     print(f"{email} : {hashpassword}")
...
def save_data_in_table_login_session(username, token, email, createdTime):
    ...
    # Thêm dữ liệu vào bảng diseases
    cursor.execute(
        f"INSERT INTO login_session (username, token,email ,createdTime) VALUES (?,?,?,?)",
